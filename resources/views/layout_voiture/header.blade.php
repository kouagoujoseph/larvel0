                ...
                <div class="container-fluid d-flex justify-content-center align-items-center">
                    <div class="d-flex align-items-center nav-content" id="nav-content">
                        <div class="collapse navbar-collapse d-lg-flex d-md-none  w-100" id="navbarSupportedContent">
                            <ul class="navbar-nav mb-2 mb-lg-0 w-100 d-flex justify-content-between align-items-center ">
                                    ...
                                    <li class="nav-item "><a class="nav-link text-black text-uppercase"
                                            href="/location"><strong><i class="bx bxs-badge"></i> Gestion-voiture</strong></a></li>
            
                                    <li class="nav-item ">
                                        <a class="nav-link text-black text-uppercase "
                                            href="louer_materiel"><strong> <i class="bx bx-list-ol"></i> Voitures-louées</strong></a>
                                    </li>
            
                                    <li class="nav-item ">
                                        <a class="nav-link text-black text-uppercase"
                                            href="louer_materiel"><strong><i class="bx bx-taxi"></i> louer-voiture</strong></a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link text-black text-uppercase" href="#temoignage"><strong>
                                            <i class="bx bx-redo"></i> Rendre-voiture</strong></a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a class="nav-link text-black text-uppercase"
                                            href="#contact"><strong> <i class="bx bx-phone-outgoing"></i> Contactez-nous</strong></a>
                                    </li>
                                    @if (Route::has('login'))
                        @auth
                        ...
                        <div class="offcanvas offcanvas-end bg-bbcar-color" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="offcanvas-header">
                                ...
                                <button type="button" class=" border-none border-0 btn-x text-reset" data-bs-dismiss="offcanvas"
                                    ...
                                    <i class="btn-x">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="#FFF" class="bi bi-x"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="offcanvas-body w-100 p-0 m-0">
                                <ul class="p-0 m-0">
                                    ...
                                    <li class="nav-item"><a class="nav-link " href="\louer_materiel">Voitures louées</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#temoignage">Louer-voiture</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#contact">Rendre-voiture</a></li>
