...
@section('content')
   ...
   <div>Votre Panier</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="legalMentionsModalLabel"></h5>
    ...
    <a href="{{ route('voitures') }}" class="btn btn-primary waves-effect waves-light offset-5 text-white"> <i class="bx bx-add-to-queue"></i> Ajouter location
  </a>
